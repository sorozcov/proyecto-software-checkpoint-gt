...
function MenuStackScreen({ theme }) {
    ...
    return (
        ...
        <MenuStack.Screen
            name="CategoriesList"
            options={{ title: 'CATEGORÍAS', headerTitleAlign:'center'}}
            component={CategoriesList}
        />
        <MenuStack.Screen
            name="EditProductScreen"  
            options={{ title: 'NUEVO PRODUCTO', headerTitleAlign:'center'}}
            component={EditProductScreen}
        />
        <MenuStack.Screen
            name="EditCategoryScreen"  
            options={{ title: 'NUEVA CATEGORÍA', headerTitleAlign:'center'}}
